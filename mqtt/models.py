...
class Plant(models.Model):
    ...
    sunlight = models.CharField(max_length=128, default="", blank="", null="")
    water = models.DecimalField(max_digits=6, decimal_places=3)
    soil_type = models.DecimalField(max_digits=6, decimal_places=3)
    minHumidity = models.DecimalField(max_digits=6, decimal_places=3)
    maxHumidity = models.DecimalField(max_digits=6, decimal_places=3)
    minTemperature = models.DecimalField(max_digits=6, decimal_places=3)
    maxTemperature = models.DecimalField(max_digits=6, decimal_places=3)
